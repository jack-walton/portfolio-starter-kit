...
I have wanted to develop a personal website for sometime now. In the past, when I've applied for or interviewed for jobs, I had been asked for an online portfolio, and I didn't have a ready solution for the request. Socially, I've found myself in the situation where acquaintances have asked for my socials, and we go through the awkward process of trying to find a social media platform that we both use. I felt that I needed a single source of truth that strangers could use to learn more about me.

## Solution

I decided to purchase jackwalton.xyz and create a personal website. I wanted it to be versatile. So in terms of content design, I decided to aim for something between [the personal website for my organization's vice president](https://darmourdesign.com/) and a [linktree for a social media personality](https://linktr.ee/tyler02020202).

After some research, I decided to host my website on Vercel. I had tried other options such as GitHub Pages. But I found GitHub Pages to be too open ended. I found it daunting to build a professional-looking website totally from scratch. In the end, I don't really consider myself an engineer. But at the same time, I didn't want to use a totally drag-and-drop solution such as Wordpress or what have you. I work in the tech industry, so even if I'm not prepared to design a web application from the ground up, I wanted to at least demonstrate that I could work on it enough to customize the front end content. Vercel worked for me because it provides a full web hosting solution along with templates. I decided to deploy a clone of the [portfolio starter kit](https://vercel.com/templates/portfolio/portfolio-starter-kit) and start to customize it.

I learned how Next.js and React worked pretty quickly. The web apps I work with at Oracle aren't exactly React applications, but the concepts are basically the same and I didn't really find the learning curve that steep. I began to change out the text in the website so that it was about me and I wired up the social media links with my own sites. But I had a couple of deeper issues with the design and logic of the template application that required that I get under the hood a bit.
